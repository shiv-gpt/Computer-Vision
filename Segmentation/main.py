...
if __name__ == '__main__':
    ...
    img_target = cv2.imread("example_output.png", cv2.IMREAD_COLOR)

    
    centers, color_hists, superpixels, neighbours = superpixels_histograms_neighbors(img)
    ...
    """for id in fg_segments:
        print "id = " + str(id)
        print superpixels[id]"""
    ...
    # img_output = cv2.imread(sys.argv[3] + "mask.png", cv2.IMREAD_COLOR)
    # diff = RMSD(img_target, img_output)
    # print "RMSD DIFF = " + str(diff)
